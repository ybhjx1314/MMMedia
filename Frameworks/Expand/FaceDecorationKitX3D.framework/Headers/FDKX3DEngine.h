...
#if ARSTUDIO_DEBUG
#import <XESceneiOS/XSKScriptBridge.h>
#else
...
+ (void)setMetalEnable:(BOOL) useMetal;
...
- (BOOL)configResourcePath:(NSString *)resourcePath NS_DEPRECATED_IOS(9.0, 11.0, "this function is being deprecated.");
